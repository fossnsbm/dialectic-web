                ...
                <TooltipTrigger asChild>
                  {isAccordionItem ? (
                    ...
                    <Link
                      ...
                      className={cn(
                        'flex items-center gap-9 overflow-hidden rounded-md py-2 text-sm font-medium hover:bg-blue-0 hover:text-accent-foreground ',
                        path === item.href ? 'bg-blue-50' : 'transparent',
                        item.disabled && 'cursor-not-allowed opacity-80',
                      )}
                      onClick={() => {
                        if (setOpen) setOpen(false)
